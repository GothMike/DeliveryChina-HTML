    ...
    <section className="promo">
      <Container>
        <div className="promo__header">
          <h2 className="promo__name">Global Opt - логистика полного цикла из Китая в Россию</h2>
          <h1 className="promo__activity">ДОСТАВКА ГРУЗОВ ИЗ КИТАЯ</h1>
        ...
        <div className="promo__tasks">
          <div className="promo__item">
            <div className="promo__img">
              <img src="icons/promo/Task_1.webp" alt="Task_1" />
            </div>
            <div className="promo__descr">Перевозка негабаритных и крупнотоннажных грузов</div>
          </div>
          <div className="promo__item">
            <div className="promo__img">
              <img src="icons/promo/Task_2.webp" alt="Task_1" />
            </div>
          ...
          <div className="promo__item">
            <div className="promo__img">
              <img src="icons/promo/Task_3.webp" alt="Task_1" />
            </div>
            <div className="promo__descr">
          ...
          <div className="promo__item">
            <div className="promo__img">
              <img src="icons/promo/Task_4.webp" alt="Task_1" />
            </div>
            <div className="promo__descr">
